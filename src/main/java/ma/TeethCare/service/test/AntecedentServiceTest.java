...
public class AntecedentServiceTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            AntecedentServiceTest service = new AntecedentServiceTest(repo);
    ...
    public AntecedentServiceTest(AntecedentRepository antecedentRepository) {
    ...
    public static void testCreate(AntecedentServiceTest service) throws Exception {
    ...
    public static void testFindById(AntecedentServiceTest service) throws Exception {
    ...
    public static void testFindAll(AntecedentServiceTest service) throws Exception {
    ...
    public static void testUpdate(AntecedentServiceTest service) throws Exception {
    ...
    public static void testDelete(AntecedentServiceTest service) throws Exception {
    ...
    public static void testExists(AntecedentServiceTest service) throws Exception {
    ...
    public static void testCount(AntecedentServiceTest service) throws Exception {
