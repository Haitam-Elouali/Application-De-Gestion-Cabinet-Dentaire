...
public class TestRepo {
    ...
    public void createTestRepo() {
        ...
        antecedentRepo.create(this.antecedent = antecedent.createTestInstance(this.patient));
        rdvRepo.create(this.rdv = rdv.createTestInstance(this.patient, this.medecin));
        ...
        certificatRepo.create(this.certificat = certificat.createTestInstance(this.patient, this.medecin));
        interventionRepo.create(this.intervention = interventionMedecin.createTestInstance(this.medecin, this.consultation));
    ...
    public void updateTestRepo()
    {
        ...
        this.cabinet.setNom("Cabinet Dentaire Updated");
        cabinetRepo.update(this.cabinet);

        // Update role - using description property
        this.role.setDescription("Role Updated");
        ...
        this.acte.setLibeller("Acte Updated");
        ...
        this.log.setAction("Action Updated");
